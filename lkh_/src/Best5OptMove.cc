...
Node *Best5OptMove(Node *t1, Node *t2, GainType *G0, GainType *Gain) {
    ...
    Node *T3 = 0, *T4 = 0, *T5 = 0, *T6 = 0, *T7 = 0, *T8 = 0, *T9 = 0,
         *T10 = 0;
    GainType G1, G2, G3, G4, G5, G6, G7, G8, BestG8 = -INFINITY;
    int64_t Case6 = 0, Case8 = 0, Case10 = 0, BestCase10 = 0, X4, X6, X8, X10,
        BTW275 = 0, BTW674 = 0, BTW571 = 0, BTW376 = 0, BTW574 = 0,
        BTW671 = 0, BTW471 = 0, BTW673 = 0, BTW573 = 0, BTW273 = 0;
    int64_t Breadth2 = 0, Breadth4, Breadth6, Breadth8;
    ...
    for (auto *Nt2 = t2->CandidateSet.data(); (t3 = Nt2->To); Nt2++) {
        ...
        for (X4 = !Asymmetric ? 1 : 2; X4 <= 2; X4++) {
            ...
            for (auto *Nt4 = t4->CandidateSet.data(); (t5 = Nt4->To); Nt4++) {
                ...
                for (X6 = 1; X6 <= 2; X6++) {
                    ...
                    for (auto *Nt6 = t6->CandidateSet.data(); (t7 = Nt6->To); Nt6++) {
                        ...
                        for (X8 = 1; X8 <= 2; X8++) {
                            ...
                            if (t8 != t1 &&
                                !Forbidden(t8, t1) &&
                                (Case6 == 3 ? BTW574 : Case6 == 4 ? !BTW671 : Case6 == 7 ? BTW273 : Case6 != 8 && X8 == 1) &&
                                (CurrentPenalty != 0 ||
                                 TSPTW_Makespan ||
                                 !c || G6 - c(t8, t1) > 0)) {
                                *Gain = G6 - C(t8, t1);
                            ...
                            /* Choose (t8,t9) as a candidate edge
                               emanating from t8 */
                            for (auto *Nt8 = t8->CandidateSet.data(); (t9 = Nt8->To);
                                 Nt8++) {
                                ...
                                for (X10 = 1; X10 <= 2; X10++) {
                                    if (X10 == 1) {
                                        ...
                                        switch (Case8) {
                                            case 1:
                                                t10 = (BTW275 ? BETWEEN(t8, t9, t5) || BETWEEN(t3, t9, t1) : BTW674 ? BETWEEN(t7, t9, t1) : BETWEEN(t7, t9, t5))
                                                          ? PRED(t9)
                                                          : SUC(t9);
                                                Case10 = 22;
                                                break;
                                            case 2:
                                                t10 = (BTW376 ? BETWEEN(t8, t9, t4) : BTW571 ? BETWEEN(t7, t9, t1) || BETWEEN(t3, t9, t6) : BETWEEN(t7, t9, t1))
                                                          ? PRED(t9)
                                                          : SUC(t9);
                                                Case10 = 23;
                                                break;
                                            ...
                                            case 4:
                                                ...
                                                break;
                                            case 5:
                                                t10 = (BTW471 ? BETWEEN(t7, t9, t1) : BTW673 ? BETWEEN(t7, t9, t5) : BETWEEN(t4, t9, t1) || BETWEEN(t7, t9, t5))
                                                          ? PRED(t9)
                                                          : SUC(t9);
                                                Case10 = 26;
                                                break;
                                            case 6:
                                                t10 = (BTW471 ? BETWEEN(t7, t9, t3) : BTW573 ? BETWEEN(t8, t9, t6) : BETWEEN(t4, t9, t1) || BETWEEN(t8, t9, t6))
                                                          ? PRED(t9)
                                                          : SUC(t9);
                                                Case10 = 27;
                                                break;
