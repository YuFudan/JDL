...
static int64_t HeapCount;    /* Its current number of elements */
static int64_t HeapCapacity; /* Its capacity */

/*
 * The HeapMake function creates an empty heap.
 */

void HeapMake(int64_t Size) {
...
void HeapSiftUp(Node *N) {
    int64_t Loc = N->Loc, Parent = Loc / 2;
