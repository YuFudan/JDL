...
static void KarpPartition(int64_t start, int64_t end);
static void CalculateSubproblems(int64_t start, int64_t end);

static Node **KDTree;
static GainType GlobalBestCost, OldGlobalBestCost;
static int64_t CurrentSubproblem, Subproblems;
